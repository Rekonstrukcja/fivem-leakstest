...
const categories = {
    lokalizacje: [
        { name: "DarkShop", images: ["darkshop1.png", "darkshop2.png", "darkshop3.png"], description: "DarkShop z nielegal itemami", download: "" },
        { name: "Domy", images: ["dom1.png", "dom2.png"], description: "Zlecenia na łupanie chaup", download: "" },
        { name: "Grupa6", images: ["grupa1.png", "grupa2.png", "grupa3.png"], description: "Zlecenia na łupanie grupe6", download: "" },
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    fetch('https://servers-frontend.fivem.net/api/servers/single/r8b5y8')

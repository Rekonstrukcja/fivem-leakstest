...
const categories = {
    lokalizacje: [
        { name: "ChopShop", images: ["chopshop1.png", "chopshop2.png", "chopshop3.png"], description: "Zlecenia na kradziez fur", download: "" },
 
        //         { name: "", images: [".png"], description: "", download: "" },
    ],
    narko: [
        { name: "Zioło", images: ["weed1.png", "weed2.png", "weed3.png", "weed4.png", "weed5.png"], description: "Strefy z sadzeniem zioła", download: "" },
        { name: "Zioło stół", images: ["stol1.png", "stol2.png", "stol3.png", "stol4.png", "stol5.png"], description: "Stół do craftingu zioła", download: "" },
    ]
        //         { name: "", images: [".png"], description: "", download: "" },
};
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    fetch('https://servers-frontend.fivem.net/api/servers/single/a746qz')

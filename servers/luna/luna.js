...
const categories = {
    lokalizacje: [
        { name: "DarkShop", images: ["darkshop1.png", "darkshop2.png", "darkshop3.png", "darkshop4.png", "darkshop5.png", "darkshop6.png"], description: "Darkshop do którego się trzeba tepać normalnie trzeba mieć dostęp", download: "" },
        { name: "Tracker", images: ["tracker1.png", "tracker2.png"], description: "Zlecenia na kradziez fur", download: "" },
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    fetch('https://servers-frontend.fivem.net/api/servers/single/dbpxyy')
